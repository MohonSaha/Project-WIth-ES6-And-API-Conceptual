...
const serachAllData = (id) => {
  ...
  document.getElementById("single-player-details").innerHTML = "";  // To clear the data of the single player. 
  document.getElementById("male").classList.add("d-none");  // Add the class display none for every time data show.
...
const showPlayerData = (players) => {
  document.getElementById("search-value").value = "";   // Clear the search bar when data load is complete.
